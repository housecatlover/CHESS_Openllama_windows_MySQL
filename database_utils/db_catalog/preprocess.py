...
EMBEDDING_FUNCTION = OllamaEmbeddings(model="llama3.2:latest")  # todo this is just my version
...
def make_db_context_vec_db(db_directory_path: str, **kwargs) -> None:
    ...
    print("len: " + str(len(table_description.items())))
    docs = []
    ...
    if len(docs) == 0:
        print("No documents found. Check your DB path or data source.")
