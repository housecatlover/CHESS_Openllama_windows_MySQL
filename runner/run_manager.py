...
class RunManager:
    ...
    def update_final_predictions(self, question_id: int, final_sql: str = None, db_id: int = None):
        ...
        with portalocker.Lock(file_path, mode='r+', flags=portalocker.LOCK_EX) as f:
            results = json.load(f)
