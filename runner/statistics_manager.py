...
class StatisticsManager:
    ...
    def update_stats(self, db_id: str, question_id: str, validation_for: str, result: Dict[str, Any]):
        ...
        """
        if result is None:
            raise ValueError(f"[task_done] No result was returned for db_id='{db_id}', question_id='{question_id}'. "
                             f"This likely means a model failed or the agent chain was interrupted.")
